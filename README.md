...
https://www.google.com/search?q=como+usar+css+en+cada+componente+react+en+un+archivo+separado&oq=como+usar+css+en+cada+componente+react+en+un+archivo+separado&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCTMyMjA2ajFqNKgCALACAQ&sourceid=chrome&ie=UTF-8